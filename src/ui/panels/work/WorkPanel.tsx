...
export function WorkPanel() {
  const { activeObject, workspaceMode, compareObject } = useActiveObject();
  ...
  return (
    <PanelShell panelId="work" title="Work" isMock>
      {/* Tab Bar */}
      <div
        style={{
          display: 'flex',
        ...
        <div>
          {activeTab === 'detail' && (
            <div>
              ...
              {/* Local Commands */}
              <div style={{ display: 'flex', gap: tokens.space.sm, marginTop: tokens.space.lg }}>
                <button
          ...
          {activeTab === 'drawing' && (
            <div style={{ color: tokens.color.fgMuted, fontSize: tokens.font.sizeSm }}>
              <div style={{ padding: tokens.space.lg, textAlign: 'center', border: `1px dashed ${tokens.color.border}`, borderRadius: tokens.radius.md }}>
                ...
                <div style={{ marginTop: tokens.space.sm, color: tokens.color.mock, fontSize: tokens.font.sizeXs }}>
                  Artifact adapter: {adapters.artifact.adapterName} (mock: {String(adapters.artifact.isMock)})
                </div>
              </div>
            </div>
          )}
